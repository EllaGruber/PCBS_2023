...
#target1 = stimuli.Ellipse(radii=(50, 50), line_width=4)
#target2 = stimuli.FixCross(size=(50, 50), line_width=4)
#audiotarget= stimuli.Audio("click.wav")
...
for i_trial in range(N_TRIALS):
    ...
    rd_number = random.randint(0,9)
    number_target = stimuli.TextBox(str(rd_number),size=(50,50))
    number_target.present()
...
# for i_trial in range(N_TRIALS//2):
#     blankscreen.present()
#     waiting_time = random.randint(MIN_WAIT_TIME, MAX_WAIT_TIME)
#     exp.clock.wait(waiting_time)
#     target1.present()
...
# for i_trial in range(N_TRIALS//2, N_TRIALS):
#     blankscreen.present()
#     waiting_time = random.randint(MIN_WAIT_TIME, MAX_WAIT_TIME)
#     exp.clock.wait(waiting_time)
#     target.present()
